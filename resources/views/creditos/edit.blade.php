                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('creditos.update', $creditos) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="acuerdo" type="text" class="form-control @error('acuerdo') is-invalid @enderror" name="acuerdo" value="{{ old('acuerdo', $creditos->acuerdo) }}" required autocomplete="acuerdo" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="detalle" type="text" class="form-control @error('detalle') is-invalid @enderror" name="detalle" value="{{ old('detalle', $creditos->detalle) }}" required autocomplete="detalle" autofocus>
